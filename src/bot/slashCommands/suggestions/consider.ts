...
export default class ConsiderSuggestion extends SlashCommand {
    constructor(client: BetterClient) {
        super("consider", client, {
            description: "Consider a suggestion.",
            guildOnly: true,
            options: [
                {
                    name: "suggestion",
                    description: "The number of the suggestion to consider.",
                    type: "INTEGER",
                    required: true
                },
                {
    ...
    override async run(interaction: CommandInteraction) {
        ...
        try {
            await suggestionMessage.edit(
                this.client.functions.generateWarningMessage(
                    {
                        author: suggestionMessage.embeds[0].author!,
                        title: `Suggestion #${suggestion.suggestionNumber} Considered`,
                ...
                this.client.functions.generateSuccessMessage(
                    {
                        ...
                        description: `Find the suggestion you considered [here](${suggestionMessage.url}).`
                    },
                    [],
                    true
                )
