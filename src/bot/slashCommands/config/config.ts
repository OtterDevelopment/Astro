...
export default class Config extends SlashCommand {
    /**
     * Our Twemoji regex for unicode emojis.
     */
    private readonly twemojiRegex: RegExp;
    ...
    override async run(interaction: CommandInteraction) {
        if (
            ...
            if (interaction.options.getSubcommand() === "set") {
                const emojiSplit = interaction.options
                    .getString("emoji")!
                    .split(":");
                    ...
                    interaction.reply(
                        this.client.functions.generateSuccessMessage({
                            ...
                            description: `${this.client.functions.titleCase(
                                interaction.options.getString("type")!
                            )} emoji has been set to ${interaction.options.getString(
                                "emoji"
                            )}!`
                        })
                    )
